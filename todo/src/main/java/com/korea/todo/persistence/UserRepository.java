...
public interface UserRepository extends JpaRepository<UserEntity, String>{
	...
	UserEntity findByUsernameAndPassword(String username, String password); //username과 password 값으로 데이터 한 건을 찾아 반환함
	//And가 사용되었으므로, 두 필드를 모두 만족하는 데이터를 찾는 조건으로 쿼리가 생성됨
}
