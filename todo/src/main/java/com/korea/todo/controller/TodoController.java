...
//	}
	...
	//Principal : 시쿠리티에서 현재 인증된 사용자를 나타내는 객체
	//주로 SecurityContextHolder에 저장된 Authentication객체를 통해 접근할 수 있음
	//Authentication 객체의 getPrincipal()메서드는 인증된 사용자의 정보를 담고 있으며 이 정보는 @AuthenticationPrincipal 어노테이션을 통해
	//컨트롤러 메서드에 자동으로 주입됨
