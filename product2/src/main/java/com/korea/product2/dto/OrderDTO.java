...
public class OrderDTO {
	...
	public OrderDTO(OrderEntity entity) {
		...
		this.productId = entity.getProduct().getId(); // ProductId
		this.productName = entity.getProduct().getProductName();
		this.productPrice = entity.getProduct().getProductPrice();
		this.productCount = entity.getProductCount();
		this.totalPrice = this.productPrice * this.productCount;
		this.orderDate = entity.getOrderDate().toString(); // 문자열로 변환
	}
